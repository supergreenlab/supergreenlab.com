...
<template>
  <section :id='$style.container'>
    ...
    <div :id='$style.body'>
      ...
      <h1>Cookie Policy for SuperGreenLab</h1>

      <p>This is the Cookie Policy for SuperGreenLab, accessible from https://www.supergreenlab.com</p>
      ...
      <ul>
        <li>Email: towelie@supergreenlab.com</li>
