...
module.exports.fetchWidgets = async () => {
  ...
  let widgets = await fetchTable('Widgets', ['slug', 'component', 'title', 'description', 'collections', 'picture', 'linktext', 'link', 'products', 'producttypes', 'plantid', 'guide','date', 'expiration', 'order',])
