...
export default {
  components: { Step, },
  props: ['bigleds', 'smallleds', 'tinyleds', 'ventilation', 'sensor',],  
}
</script>
...
#smalllight
  width: 50pt
  background-image: url('~assets/img/smalllight.svg')

#tinylight
  width: 50pt
  background-image: url('~assets/img/tinylight.svg')

#ventilation
  background-image: url('~assets/img/ventilation.svg')
